...
export default function CareerLanding() {
  ...
  const inView = useInView(featuresRef, { amount: 0.2, once: false }); // ✅ triggers on scroll down & up
    ...
    <div className="w-full bg-black text-white overflow-x-hidden">
      ...
      >
        ...
        <motion.div
          ...
          initial="hidden"
          animate={inView ? "visible" : "hidden"} // ✅ animate on both scroll directions
        >
...
const TestimonialsSection = () => {
  ...
  return (
    <section ref={ref} className="px-6 py-24 bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-4">Trusted by Ambitious Professionals</h2>
        <p className="text-gray-400 max-w-2xl mx-auto mb-16">Hear from others who have accelerated their careers with us.</p>
      </div>
